    ...
    return (
        <div className="about">
            ...
            <div className="aboutContent">
                ...
                <p className="mobile pageOne">In his free time, William enjoys making music and reading about the subjects your grandpa probably likes (boats,plants,history). </p>
