...
function Floppy() {
    ...
    // pass props with color attributes, custom className
    ...
    return (
            <svg className='floppy'>
                <path fill="#2884A9" d="M425.6,6H390v192c0,9.6-5.6,20-15.6,20H70c-10,0-20-10-20-20V6H22.4C14.4,6,6,10.4,6,18v467.6
                    c0,7.6,8.8,16.4,16.4,16.4H50V270v-2c0-1.2,0.8-2,2-2h404c1.2,0,2,0.8,2,2v234h32c7.6,0,12-8.4,12-16.4V82.8L425.6,6z"/>
                <rect x="54" y="266" fill="#73BADD" width="400" height="236"/>
                <path fill="#E8E3E3" d="M54,6v192c0,7.6,8.4,16,16,16h304.4c7.6,0,11.6-8.4,11.6-16V6H54z"/>
                <rect x="282" y="38" fill="#2884A9" width="72" height="144"/>
